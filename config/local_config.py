...
1: {'model_name': "ARD-VAE",
 ...
 3: {'model_name': "ARD-VAE",
     'dataset_name': "MNIST",
     'batch_size': 100,
     'epochs': 50,
     'latent_dim': 16,                  # Table 2 Paper Benchmark
     'num_filter': 64,
     't_stat_samples': 10000,
     'update_hyperpriors': 1,
     'update_t_stat_epoch_fraction': 1,
     'print_every_epoch': 1,
     'save_every_epoch': 10,
     'dec_reg_strength': 0,
     'learning_rate': 5e-04,
 ...
 4: {'model_name': "ARD-VAE",
     'dataset_name': "CIFAR10",
     'batch_size': 100,
     'epochs': 100,
     'latent_dim': 128,                 # Table 2 Paper Benchmark
     'num_filter': 128,
     't_stat_samples': 10000,
     'update_hyperpriors': 1,
     'update_t_stat_epoch_fraction': 1,
